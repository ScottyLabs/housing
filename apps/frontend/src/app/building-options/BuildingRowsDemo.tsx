...
export function BestFit() {
  const best_fit_buildings = [
    useBuildingById("etower"),
    useBuildingById("stever"),
    useBuildingById("boss"),
  ];
  return (
    <BuildingOptionRow
...
export function DecentFit() {
  const decent_fit_buildings = [
    useBuildingById("donner"),
    useBuildingById("henderson"),
    useBuildingById("mcgill"),
  ];
  return (
    <BuildingOptionRow
      title="Decent Fit"
...
export function WildCard() {
  const wild_card_buildings = [
    useBuildingById("fifth"),
    useBuildingById("scobell"),
    useBuildingById("welch"),
  ];
  return (
    <BuildingOptionRow
      title="Wild Card"
