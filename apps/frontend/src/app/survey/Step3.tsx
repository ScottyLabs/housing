...
const AMENITIES = ["Air conditioning", "En suite bathroom", "En suite kitchen", "Common areas", "Kitchen access"];
...
export default function Step3() {
    return (
        <>
            ...
            <div className="rounded-[18px] border border-black/10 bg-brand-menugray px-8 py-8">
                <h2 className="text-[24px] font-semibold leading-none">Do you have any preferred amenities?</h2>
